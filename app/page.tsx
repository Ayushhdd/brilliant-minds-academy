      ...
      <section className="journeySection" id="journey">
        ...
        <aside className="container journeyDifference journeyDifferenceWide" data-reveal>
              <div className="journeyDifferenceIntro">
                ...
                <p className="differenceInteractionHint"><span className="desktopFlipHint">Hover a card to reveal the classroom image.</span><span className="mobileFlipHint">Swipe to browse &middot; Tap a card to reveal the photo.</span></p>
              </div>
              <DifferenceCards />
        </aside>
      </section>
